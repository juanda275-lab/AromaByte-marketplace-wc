...
DROP POLICY IF EXISTS "Cualquiera puede ver productores" ON producers;
DROP POLICY IF EXISTS "Los productores pueden actualizar su perfil" ON producers;
...
DROP POLICY IF EXISTS "Los productores pueden gestionar sus productos" ON products;
...
DROP POLICY IF EXISTS "Los usuarios pueden ver sus propios pedidos" ON orders;
DROP POLICY IF EXISTS "Los usuarios pueden crear pedidos" ON orders;
DROP POLICY IF EXISTS "Los productores pueden ver pedidos de sus productos" ON orders;
...
DROP POLICY IF EXISTS "Los usuarios pueden ver sus notificaciones" ON notifications;
DROP POLICY IF EXISTS "Los usuarios pueden actualizar sus notificaciones" ON notifications;
...
DROP POLICY IF EXISTS "Cualquiera puede ver reseñas" ON product_reviews;
DROP POLICY IF EXISTS "Los usuarios pueden crear reseñas" ON product_reviews;
DROP POLICY IF EXISTS "Los usuarios pueden actualizar sus reseñas" ON product_reviews;
