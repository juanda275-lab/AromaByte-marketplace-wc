    ...
    <section className="py-16 lg:py-24 bg-coffee-beige">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-poppins font-bold text-3xl lg:text-4xl text-coffee-primary mb-4">Nuestros Productores</h2>
            ...
            >
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  ...
                  <h3 className="font-poppins font-bold text-xl text-coffee-primary mb-1">{producer.name}</h3>
                  <p className="text-coffee-secondary font-medium mb-2">{producer.farmName}</p>
